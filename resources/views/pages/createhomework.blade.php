            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{ asset('createhomework') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword2" class="col-sm-3 col-form-label">File bài tập</label>
                        <div class="col-sm-12" >
